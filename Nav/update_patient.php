...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Call the update method and pass all 12 parameters
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p><strong>First Name:</strong> <?= htmlspecialchars($patient['first_name']) ?></p>
                            <p><strong>Middle Name:</strong> <?= htmlspecialchars($patient['middle_name']) ?></p>
                            <p><strong>Last Name:</strong> <?= htmlspecialchars($patient['last_name']) ?></p>
                            <p><strong>Age:</strong> <?= htmlspecialchars($patient['age']) ?></p>
                            <p><strong>Sex:</strong> <?= $patient['sex'] === 'M' ? 'Male' : 'Female' ?></p>
                            ...
                            <p><strong>Height:</strong> <?= htmlspecialchars($patient['height']) ?> cm</p>
