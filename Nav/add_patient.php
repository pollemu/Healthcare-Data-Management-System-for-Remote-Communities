...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $age = $_POST['age'];
    $sex = $_POST['sex'];
    $contact_number = '+63' . ltrim($_POST['contact'], '+63');  // Renamed to contact_number
    $address = $_POST['address'];
    $blood_type = $_POST['blood'];  // Renamed to blood_type
    ...
    <div class="card shadow mx-auto" style="max-width: 850px;">
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <!-- Additional Fields for Age, Sex, Contact -->
                <div class="form-row">
                ...
                <!-- Address, Blood Type, Date of Birth, Height and Weight -->
